...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemp_rec = recession_data.groupby(["Vehicle_Type", "unemployment_rate"], as_index=False)["Automobile_Sales"].mean()
        R_chart4 = dcc.Graph(
        ...
        return [
            html.Div(className='chart-itemTop', children=[html.Div(children=R_chart1),html.Div(children=R_chart2)],style={"display": "flex"}),
            html.Div(className='chart-itemBottom', children=[html.Div(children=R_chart3),html.Div(children=R_chart4)],style={"display": "flex"})
            ]
